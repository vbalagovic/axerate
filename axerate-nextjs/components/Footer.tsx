        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-subtle mb-6 max-w-md">
              From zero to venture. We are the operational co-founder for
              visionary startups, providing end-to-end solutions from ideation
              to funding.
            </p>
            <div className="flex space-x-4">
              <Link
                href="https://twitter.com/axerate"
                target="_blank"
              ...
              <Link
                href="https://linkedin.com/company/axerate"
                target="_blank"
                className="flex items-center justify-center w-10 h-10 bg-card border border-strong rounded-lg text-subtle hover:text-violet-400 hover:border-violet-500/30 transition-all duration-300"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <span className="text-subtle">ventures@axerate.com</span>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-center md:text-left mb-4 md:mb-0">
              <p className="text-subtle text-sm">
                © 2025 Axerate. All rights reserved.
              </p>
            </div>
