...
export interface ApiArchitectsSectionArchitectsSection
  extends Struct.SingleTypeSchema {
  collectionName: 'architects_sections';
  info: {
    description: 'Architects of Ambition section content';
    displayName: 'Architects Section';
    pluralName: 'architects-sections';
    singularName: 'architects-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::architects-section.architects-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog articles and legal insights';
...
export interface ApiContactSubmissionContactSubmission
  ...
  attributes: {
    ...
    fundingStatus: Schema.Attribute.Enumeration<
      ['Not Applicable', 'Bootstrapped', 'Pre-Seed', 'Seed', 'Series A+']
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    status: Schema.Attribute.Enumeration<
      ['new', 'contacted', 'in-progress', 'completed', 'archived']
    > &
      Schema.Attribute.DefaultTo<'new'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ventureStage: Schema.Attribute.Enumeration<
      [
        'General Inquiry',
        'Idea Stage',
        'Prototype/MVP',
...
export interface ApiGeneralInquiryGeneralInquiry
  ...
  info: {
    description: 'General contact form submissions from the main page';
    displayName: 'General Inquiry';
    pluralName: 'general-inquiries';
    singularName: 'general-inquiry';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    budget: Schema.Attribute.Enumeration<
      ['budget_10k_20k', 'budget_20k_50k', 'budget_50k_plus']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::general-inquiry.general-inquiry'
    > &
      Schema.Attribute.Private;
    message: Schema.Attribute.Text & Schema.Attribute.Required;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiHeroSectionHeroSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaButtonLink: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiNewsletterSubscriptionNewsletterSubscription
  ...
  info: {
    description: 'Newsletter email subscriptions from blog';
...
export interface ApiPageMetadataPageMetadata
  extends Struct.CollectionTypeSchema {
  collectionName: 'page_metadata';
  info: {
    description: 'SEO metadata for different pages';
...
export interface ApiProcessStepProcessStep extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Steps in the Axerate process';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    page: Schema.Attribute.Enumeration<['main', 'startup']> &
      Schema.Attribute.Required &
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Services offered by Axerate';
    displayName: 'Service';
    pluralName: 'services';
...
export interface ApiStartupHeroStartupHero extends Struct.SingleTypeSchema {
  collectionName: 'startup_hero';
  info: {
    description: 'Startup Studio page hero section content';
    displayName: 'Startup Studio Hero';
    pluralName: 'startup-heros';
    singularName: 'startup-hero';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiVentureCatalystVentureCatalyst
  extends Struct.SingleTypeSchema {
  collectionName: 'venture_catalyst_sections';
  info: {
    description: 'Venture Catalyst Framework section content';
    displayName: 'Venture Catalyst Section';
    pluralName: 'venture-catalyst-sections';
    singularName: 'venture-catalyst';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::venture-catalyst.venture-catalyst'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.Text & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::startup-hero.startup-hero': ApiStartupHeroStartupHero;
      'api::team-member.team-member': ApiTeamMemberTeamMember;
      'api::terms-of-service.terms-of-service': ApiTermsOfServiceTermsOfService;
      'api::venture-catalyst.venture-catalyst': ApiVentureCatalystVentureCatalyst;
